...
{
	$sql ='INSERT INTO competence(id_carte,nom_competence,type_competence,date_competence) 
VALUES
('.$contenuformulaire["carte_id"].',
...
{
{
$sql ='INSERT INTO experience(nom_experience,type_experience,lieu,date_experience,id_carte) 
VALUES
